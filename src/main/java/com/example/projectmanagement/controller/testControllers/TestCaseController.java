...
public class TestCaseController {
        ...
        @PostMapping
        @PreAuthorize("hasAnyRole('PROJECT_MANAGER','GENERAL')") // Only allow PROJECT_MANAGER and GENERAL roles to
        ...
        public ResponseEntity<TestCaseSummaryResponse> updateTestCase(
                        @PathVariable Long caseId,
                        @Valid @RequestBody TestCaseUpdateRequest request, // Or reuse TestCaseCreateRequest if
                                                                           // identical
                        @CurrentUser UserDto currentUser) {
