...
//             // ❌ External service returned 4xx (403, 401, etc.)
//             logger.warn("Permission check failed with {}: {}", e.getStatusCode(), e.getMessage());
            
//             String errorMessage = extractErrorMessage(e);
//             int statusCode = e.getStatusCode().value();
            
//             writeJsonError(response, statusCode, errorMessage);
...
//         } catch (Exception e) {
//             // ⚠️ Network/timeout error - external service completely unavailable
//             logger.error("Cannot reach permission service: " + e.getMessage());
