...
public class Securityconfig {
    ...
    private JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        converter.setJwtGrantedAuthoritiesConverter(jwt -> {
            ...
            // authorities.add(new
            // org.springframework.security.core.authority.SimpleGrantedAuthority(perm));
            // }
            // }
            return authorities;
        });
...
// // All other endpoints - allow through (PermissionCheckFilter handles
// authorization)
...
// // .addFilterAfter(permissionCheckFilter,
